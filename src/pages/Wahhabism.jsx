      ...
      <Container>
        ...
        <ContentCard>
          ...
          <HighlightBox variant="info" title={t.founderTitle}>
            ...
            <ul className="list-disc list-inside space-y-2 mt-4">
              <li>{t.founderList1}</li>
              <li>{t.founderList2}</li>
              <li>{t.founderList3}</li>
              <li>{t.founderList4}</li>
              <li>{t.founderList5}</li>
              <li>{t.founderList6}</li>
            </ul>
          </HighlightBox>
          ...
          <div className="mt-8">
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              <li><strong>{t.allianceTermPolitical.split(':')[0]}:</strong> {t.allianceTermPolitical.split(':')[1]}</li>
              <li><strong>{t.allianceTermReligious.split(':')[0]}:</strong> {t.allianceTermReligious.split(':')[1]}</li>
              <li><strong>{t.allianceTermJihad.split(':')[0]}:</strong> {t.allianceTermJihad.split(':')[1]}</li>
            </ul>
            <p>{t.alliancePara3}</p>
          </div>
        ...
        <ContentCard>
          ...
          <ul className="list-disc list-inside space-y-2 mb-6">
            <li>{t.conclusionList1}</li>
            <li>{t.conclusionList2}</li>
            <li>{t.conclusionList3}</li>
            <li>{t.conclusionList4}</li>
            <li>{t.conclusionList5}</li>
            <li>{t.conclusionList6}</li>
          </ul>
